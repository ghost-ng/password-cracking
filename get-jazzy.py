...
def start_cracking(input_file,dict_file):
    ...
    print(GREEN + "[+] Matched {} hashes".format(count))
    print("[+] Cracked file created:\n",cracked_filename + RSTCOLORS)
...
"""
    ...
    parser.add_argument('-i', dest='inputfile', action='store', default=False, help='Input File')
